...
| :--- | :--- | :--- |
| **2026-09-01** | Antigravity AI | - Refactor tách Master Prompt thành 9 Specialized Prompt Engines.<br>- Refactor `novel_engine.py` (tách components `StoryPlanner`, `ChapterPlanner`, `SceneExecutor`).<br>- Refactor `main.rs` Tauri Rust backend (tách `commands/` modules).<br>- Refactor `synchronizer.py` (tách `sync_utils.py`).<br>- Tạo file tổng quan dự án `PROJECT_OVERVIEW.md` và thiết lập quy định tự động cập nhật tiến độ cho AI. |
